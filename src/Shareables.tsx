    ...
    return (
        <Box sx={{ display: "flex", flexDirection: "column", gap: 5 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 5 }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 2, paddingTop: 2 }}>
                        ...
                        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                            <Box>
                                ...
                                <Typography variant="body1" fontWeight="bold" color={text}>
                                    +{Math.round(props.mileData.reduce((total, md) => total + md.elevationGain, 0) * 3.28084).toLocaleString()} ft
                                </Typography>
                                <Typography sx={{display: props.activityType == "RUN" ? "flex" : "none"}} variant="body1" fontWeight="bold" color={text}>
                                    {averagePaces(
                                        props.mileData,
                ...
                <button onClick={() => captureImage(titleRef)} style={{ marginTop: 10 }}>Capture Image</button>
            ...
            <Box>
                ...
                <button onClick={() => captureImage(customRef)} style={{ marginTop: 10 }}>Capture Image</button>
                <TextField
