...
import { Avatar, Box, Card, CardActionArea, CardContent, Link, Typography } from '@mui/material';
...
export const Profile = () => {
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', mt: 4, p: 2 }}>
      {/* Profile Section */}
      {userInfo && <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-start', mb: 4, gap: 2 }}>
        <Avatar
